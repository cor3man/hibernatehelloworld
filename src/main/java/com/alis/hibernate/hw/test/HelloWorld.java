...
import com.alis.hibernate.hw.model.helloworld.Item;
import com.alis.hibernate.hw.model.helloworld.Message;
...
public class HelloWorld extends TransactionManagerTest {

    @Test
    public void testAdapters() throws Exception
    {
        EntityManagerFactory emf =
                Persistence.createEntityManagerFactory("HelloWorldPU1");
