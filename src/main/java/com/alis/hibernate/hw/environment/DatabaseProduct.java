package com.alis.hibernate.hw.environment;
            ...
            new DataSourceConfiguration() {
                ...
                public void configure(PoolingDataSource ds, String connectionURL) {
                    ...
                    ds.getDriverProperties().put(
                            ...
                            connectionURL != null
                                    ? connectionURL :
                                    "jdbc:log4jdbc:mysql://localhost:3306/hwdb?user=root&password=root&useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC"
                    );

                    ds.getDriverProperties().put("driverClassName", "net.sf.log4jdbc.DriverSpy");
                }
            },
